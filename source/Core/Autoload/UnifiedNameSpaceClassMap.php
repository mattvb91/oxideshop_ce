...
/**
 * This class is NOT dead code, but used by external tools to generate the files in the unified namespace.
 *
 * This file holds the mapping of classes from the unified namespace to the concrete classes of each edition.
 ...
 */
class UnifiedNameSpaceClassMap
{

    /**
     * Return mapping of classes from the unified namespace to concrete classes.
     *
     * @return array Map of classes in the unified namespace to concrete classes
     */
